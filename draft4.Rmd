...
plot(sort(unique(black$year)), as.vector(table((as.factor(black$year)))), ylim = c(0, 150), main = "Citations by Race for Each Year", xlab="Year", ylab = "Count") #200000 when all
