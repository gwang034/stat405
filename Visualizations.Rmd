...
plot(sort(unique(black$year)), as.vector(table((as.factor(black$year)))), ylim = c(0, 100), main = "Citations by Race for Each Year", xlab="Year", ylab = "Count")
...
barplot(table(ym_dates), xlab = "Year and Month", ylab = "Frequency of Citations", col = rep(c("red", "grey", "grey", "grey", "grey", "grey", "grey", "grey", "grey", "grey", "grey", "grey"), times = 7),
     main = "Frequency of Citations vs Month and Year")
